...
export default class WriteTestCaseNoCell extends Component {
	...
	componentWillMount() {
		...
		axios.post(Constants.url + 'CheckFailedTestCase', `testCaseDetails=${encodeURIComponent(JSON.stringify(testCaseData))}`, {
			headers: {
			}
